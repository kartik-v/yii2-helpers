Contributing to yii2-helpers
============================
Looking to contribute something to yii2-helpers? **Here's how you can help.**
...
[extension documentation and demos](http://demos.krajee.com/helpers) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-helpers
--------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-helpers_.
...
- What version of jQuery are you using? And what version of yii2-helpers?
- Are you using yii2-helpers with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-helpers
------------------------------------------
Before starting work on a major feature for yii2-helpers, **read the
[documentation](http://demos.krajee.com/helpers)  first** or you may risk spending a considerable amount of
...
yii2-helpers regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-helpers that contain test cases and
...
[issue-tracker]: https://github.com/kartik-v/yii2-helpers/issues
[licensing]: https://github.com/kartik-v/yii2-helpers/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-helpers
[requesting-features]: #requesting-features-in-yii2-helpers